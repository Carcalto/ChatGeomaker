...
with st.sidebar:
    ...
    system_prompt = st.text_area("Defina o prompt do sistema:", value="Enter a default system prompt or update it dynamically here.")
...
# Função para processamento do chat com RAG
